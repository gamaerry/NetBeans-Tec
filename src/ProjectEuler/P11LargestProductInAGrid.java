    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < matriz.length; i++)
            for (int j = 0; j < matriz[0].length; j++)
                if ((j + 3) < matriz[0].length && (i + 3) < matriz.length ) {
                    mayor = Math.max(mayor, matriz[i][j]*matriz[i+1][j+1]*matriz[i+2][j+2]*matriz[i+3][j+3]);
                    mayor = Math.max(mayor, matriz[i][j]*matriz[i+1][j]*matriz[i+2][j]*matriz[i+3][j]);
                    mayor = Math.max(mayor, matriz[i][j]*matriz[i][j+1]*matriz[i][j+2]*matriz[i][j+3]);
